    ...
    <form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex justify-center">
        <button
          ...
          className="w-48 px-6 py-3 text-lg font-medium text-white bg-(--color-tertiary)/90 rounded-lg hover:bg-(--color-tertiary)/70 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
