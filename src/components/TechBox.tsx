...
const TechBox = ({ icon, label }: TechBoxProps) => {
  return (
    <div className="w-28 sm:w-32 md:w-36 h-24 sm:h-26 md:h-28 flex flex-col items-center px-3 md:px-4 py-3 md:py-4 rounded-lg bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors self-center">
