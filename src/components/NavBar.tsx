...
const NavBar = () => {
  ...
  return (
    <nav className="fixed top-0 right-0 z-50">
      ...
      <div
        className={`fixed top-0 right-0 h-screen backdrop-blur-md w-64 transform transition-all duration-300 ease-in-out ${isOpen ? "translate-x-0 shadow-[0_0_2px_rgba(255,255,255,0.2)]" : "translate-x-full"} pt-20 px-6`}
      >
        <div className="flex flex-col space-y-6">
          <Link
            href="/"
            className="text-white text-xl hover:text-white/70 transition"
