  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="w-full overflow-x-hidden pt-16 sm:pt-20 md:pt-32">
        ...
        <section
          id="portfolio"
          className="bg-(--color-secondary)/90 py-8 sm:py-12 md:py-16 flex flex-col justify-center items-center min-h-[200px] md:min-h-[300px]"
        >
        ...
        <section
          id="contact"
          className="bg-(--color-primary) py-8 sm:py-12 md:py-16 flex flex-col justify-center items-center min-h-[200px] md:min-h-[300px]"
        >
          <ContactForm />
        </section>
      </main>
