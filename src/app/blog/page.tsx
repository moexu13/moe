        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-1/5 lg:-ml-16">
            <div className="sticky top-8 bg-[var(--color-primary)]/90 rounded-xl p-6">
              <h2 className="text-lg text-white mb-4">Archives</h2>
              ...
              <h2 className="text-lg text-white mt-8 mb-4">Tags</h2>
            ...
            <div className="flex flex-col items-center">
              {blogPosts.map((post, index) => (
                <Link
                  key={post.slug}
                  href={`/blog/${post.slug}`}
                  className="w-full max-w-3xl rounded-xl p-6 mt-8 bg-[var(--color-primary)]/90 flex flex-col md:flex-row gap-12 hover:bg-[var(--color-primary)]/80 transition-colors"
                >
                  ...
                  <div className="md:w-2/3 flex flex-col justify-between">
                    <div>
                      ...
                      <h2 className="text-xl text-white mb-3">{post.title}</h2>
                    ...
                    <div className="bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-lg transition-colors flex items-center gap-2 w-fit self-end">
                      Read More
                      <Image
                        src="/icons/arrow.svg"
                        alt="arrow"
